          ...
          return this.each(function () {
               ...
               $(this).click(function (event) {
                    ...
                    setTimeout(() => {
                         ...
                         if (!popr_show) {
                              let coords = $(popr_cont)[0].getBoundingClientRect();
                              let epsilon = 15;
                              if (window.innerWidth - coords.left - epsilon < w_t) {
                                   // top right corner (90% circa)     
                                   $(popr_cont).css('margin-left', '-' + (w_t - (w_e * 2)) + 'px');
                                   $('.popr_point_'+d_m).addClass('at_corner');
                              }
                         }
                    }, 1);
